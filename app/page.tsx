...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-white">
      ...
      {/* Features Section */}
      <section className="py-12 md:py-16 bg-gradient-to-b from-[#1a1a2e] to-black">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-6">Hello there,</h2>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className="relative h-[250px] md:h-[350px] lg:h-[450px]"
            >
              <Image
                src="/mikaaynbode.jpeg"
                alt="Pastor Mike Ayanbode"
      ...
      <section className="py-12 md:py-16 bg-[#1a1a2e]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[{ title: "Healing Testimony", content: "I was healed from a chronic illness after Pastor Mike prayed for me." },
              { title: "Financial Breakthrough", content: "After following Pastor Mike's teachings on financial stewardship, I received an unexpected promotion at work." },
              { title: "Restored Relationship", content: "My marriage was on the brink of divorce, but through counseling with Pastor Mike, we've reconciled and are stronger than ever." }]
              .map((report, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <motion.div whileHover={{ scale: 1.05 }} className="bg-zinc-900 p-6 rounded-lg text-center">
